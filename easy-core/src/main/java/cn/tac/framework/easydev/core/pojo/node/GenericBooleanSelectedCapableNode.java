 ...
 * @since 2.3
 */
public class GenericBooleanSelectedCapableNode<PK, E extends NodeMinStructureAware<PK>> extends GenericNode<PK, E> implements SelectedCapableNode<PK, E, Boolean> {
