...
@ActiveProfiles("creation-repository-support")
...
public class CreationRepositorySupportTest {
    ...
    public void insert() throws Exception {
        ...
        FooEntity entity = mapper.selectByPrimaryKey(o.getId());
    ...
    @Repository
    static class FooCreationRepository implements CreationRepositorySupport<FooEntity, String> {
        @Autowired
        private FooMapper mapper;

        @Override
        public CrudMapperSupport<FooEntity> getMapper() {
            return mapper;
        }
    }

    @Mapper
    interface FooMapper extends CrudMapperSupport<FooEntity> {
    }

    @Table(name = "foo")
    static class FooEntity extends MinEntityStructure<String> implements InitializingEntity {
        private String bar1;
        private String bar2;
