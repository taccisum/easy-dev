 ...
 *
 * <p>
 *     由于使用了泛型主键，在运行时id, createdBy, updatedBy的类型将被擦除为{@link Object}，因此使用{@link cn.tac.framework.easydev.core.util.BeanUtilsWrapper}
 *     将实体类的值复制到dto对象时将无法正常复制这些字段，解决方案有二：
 *     <ul>
 *         <li>在实际代码中手动赋值：{@code dto.setId(entity.getId())}</li>
 *         <li>将dto中的id, createdBy, updatedBy类型更改为{@link Object}</li>
 *     </ul>
 * </p>
 *
 * <p>
 ...
 */
@Entity
public abstract class GenericEntityNew<PK, O> extends GenericInitializingEntity<PK> implements
        EntityInfoAwareNew<O>,
