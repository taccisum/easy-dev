...
import cn.tac.framework.easydev.web.controller.crud.api.RetrievalController;
...
public interface RetrievalControllerSupport<E extends MinEntityStructureAware<PK>, PK>
        extends RetrievalController<E, PK>, ServiceAware<E, PK>, RetrievalServiceAware<E, PK> {
