 ...
 * @since 17/11/2017
 */
public interface UpdatingControllerSupport<E extends MinEntityStructureAware<PK>, PK> extends ServiceAware<E, PK> {
    ...
    RestfulApiResponse<E> update(@PathVariable("id") PK id, @RequestBody E entity);
}
